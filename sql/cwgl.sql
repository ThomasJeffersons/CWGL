/*
 ...
 Date: 26/03/2022 17:30:16
*/

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

create database cwgl;
use cwgl;
...
CREATE TABLE `bill`  (
  ...
  `paywayid` int NULL DEFAULT NULL COMMENT '支付方式',
...
CREATE TABLE `house`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键',
  `ownerid` int NOT NULL COMMENT '户主编号',
...
CREATE TABLE `investment`  (
  ...
  `info` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '投资信息',
  `risk` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '风险，1高，3中，4低，5无',
  `earnings` decimal(10, 4) NULL DEFAULT NULL COMMENT '收益',
...
-- ----------------------------
INSERT INTO `investment` VALUES (1, '平安保险', '股票投资', '中', 100.0000, 28, '席学有', 1);
INSERT INTO `investment` VALUES (2, '中国银行', '古玩大师', '低', 101.0000, 28, '席学友', 1);
...
INSERT INTO `privilege` VALUES (68, '004', '成员管理', '0', '1', NULL, '&#xe726;');
...
INSERT INTO `privilege` VALUES (74, '004001', '成员信息', '1', '1', 'sys_users', '&#xe726;');
INSERT INTO `privilege` VALUES (75, '004002', '工作信息', '1', '1', 'sys_work', '&#xe726;');
INSERT INTO `privilege` VALUES (76, '004003', '投资信息', '1', '1', 'sys_investment', '&#xe726;');
...
CREATE TABLE `roleprivilieges`  (
  `ID` int NOT NULL AUTO_INCREMENT COMMENT '主键',
  `roleID` int NULL DEFAULT NULL COMMENT '角色维护表主键',
  `privilegeID` int NULL DEFAULT NULL COMMENT '权限维护表主键',
  PRIMARY KEY (`ID`) USING BTREE,
...
INSERT INTO `roleprivilieges` VALUES (855, 2, 75);
INSERT INTO `roleprivilieges` VALUES (867, 2, 76);
INSERT INTO `roleprivilieges` VALUES (868, 3, 75);
INSERT INTO `roleprivilieges` VALUES (869, 3, 76);
INSERT INTO `roleprivilieges` VALUES (870, 3, 68);
...
CREATE TABLE `user`  (
  ...
  `houseid` int NULL DEFAULT NULL COMMENT '所属家庭编号',
...
INSERT INTO `user` VALUES (25, 'xxx', '123', NULL, 3, NULL, NULL);
INSERT INTO `user` VALUES (28, 'xxy', '123', '席学友', 3, 1, NULL);
INSERT INTO `user` VALUES (29, 'xxy2', '123', '席学友2', 3, 1, NULL);
...
CREATE TABLE `work`  (
  ...
  `realname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `workType` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '1工作，2兼职',
  `earnings` decimal(10, 4) NULL DEFAULT NULL COMMENT '工资',
  `manner` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '工作方式',
  `houseid` int NULL DEFAULT NULL COMMENT '家庭',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of work
-- ----------------------------
INSERT INTO `work` VALUES (1, 28, 8, '敲代码', '席学有', '上班', 8000.0000, '上班', 1);
INSERT INTO `work` VALUES (2, 28, 2, '摸鱼', '席学有', '上班', 1000.0000, '123', 1);

INSERT INTO `cwgl`.`privilege` (`ID`, `privilegeNumber`, `privilegeName`, `privilegeTipflag`, `privilegeTypeflag`, `privilegeUrl`, `icon`) VALUES (77, '006', '投资管理', '0', '1', NULL, '&#xe757;');
INSERT INTO `cwgl`.`privilege` (`ID`, `privilegeNumber`, `privilegeName`, `privilegeTipflag`, `privilegeTypeflag`, `privilegeUrl`, `icon`) VALUES (78, '006001', '股票', '1', '1', 'chart_stock', '&#xe757;');
INSERT INTO `cwgl`.`roleprivilieges` (`ID`, `roleID`, `privilegeID`) VALUES (871, 2, 77);
INSERT INTO `cwgl`.`roleprivilieges` (`ID`, `roleID`, `privilegeID`) VALUES (872, 2, 78);
